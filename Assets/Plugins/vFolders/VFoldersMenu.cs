...
namespace VFolders
{
    class VFoldersMenu
    {
        ...
        [MenuItem(dir + "Upgrade to vFolders 2.1", false, 1003)]
        static void dadadssadsas() => Application.OpenURL("https://prf.hn/click/camref:1100lGLBn/pubref:upgradetovf21/destination:https://assetstore.unity.com/packages/tools/utilities/vfolders-2-255470");
