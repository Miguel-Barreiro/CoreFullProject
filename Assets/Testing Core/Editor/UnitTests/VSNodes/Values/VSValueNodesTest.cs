...
namespace Testing_Core.Editor.UnitTests.VSNodes.Values
{
	public sealed class VSValueNodesTest : UnitTest
	{
		[SerializeField] private ActionGraph ValueNodes;
		...
		[Test]
		public void ValueNodesTest()
		{
			ActionGraph actionGraph = ValueNodes;
